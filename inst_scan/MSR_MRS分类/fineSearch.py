...
def readOneOrTwoPage(pdfReader,i,El0UnbehaviorTxt,ElxBehaviorEqualTxt,ElxBehaviorDiffTxt,ElxTotalEqualTxt,EL12_EL02Txt):
    pageObj = pdfReader.getPage(i) 
    text = pageObj.extractText()
    ...
    for singleIS in Pre:
        ...
        if(Branch0):
            ...
            parseOneMRS_MSR(res,pdfReader,i,El0UnbehaviorTxt,ElxBehaviorEqualTxt,ElxBehaviorDiffTxt,ElxTotalEqualTxt,EL12_EL02Txt)
        text = originText

def parse_manual():
    
    El0UnbehaviorTxt = open('MSR_El0Unbehavior.txt','w+',encoding='utf-8')
    ...
    for i in r:
        # if i != 408: continue
        readOneOrTwoPage(pdfReader,i,El0UnbehaviorTxt,ElxBehaviorEqualTxt,ElxBehaviorDiffTxt,ElxTotalEqualTxt,EL12_EL02Txt)
